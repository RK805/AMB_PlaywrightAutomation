...
export default class RbcRoyal_personalLoansloc {
    ...
    constructor(page: Page) {
        ...
        this.borrowingReasonOptions = page.locator("//div[@class='select-wpr required']/select/option");
        ...
        this.repaymentPeriodOption = page.locator("//div[contains(@class,'input-wpr required')]/following::select[@id='calPeriod']/option");
        this.monthlyPayment = page.locator("//div[contains(@class,'input-wpr required')]/following::select[@id='calFrequency']");
        this.monthlyPaymentOption = page.locator("//div[contains(@class,'input-wpr required')]/following::select[@id='calFrequency']/option");
